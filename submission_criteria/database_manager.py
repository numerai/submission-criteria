...
BENCHMARK = 0.693
TARGETS = ["target", "target_bravo", "target_charlie", "target_delta", "target_echo"]
...
class DatabaseManager(object):
    ...
    def update_leaderboard(self, submission_id, filemanager):
        ...
        for era in validation_eras:
            ...
            logloss = log_loss(era_data[TARGETS[tournament+1]].values, submission_era_data.probability.values)
